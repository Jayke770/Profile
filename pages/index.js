import {App, Navbar, Link, Icon, Block} from 'tailwind-mobile/react'
import Head from 'next/head'
import { Bars } from 'framework7-icons/react'
export default function Home() {
  return (
    <App dark safeAreas className="">
      <Head>
        <title>Jayke770</title>
        <meta property="og:title" content="My Personal Website" key="title"></meta>
      </Head>

      <Navbar 
        title={<span className="py-3">Jayke770</span>}
        className="left-0 sticky" 
        right={
          <Link navbar iconOnly>
            <Icon><Bars className="w-7 h-7" /></Icon>
          </Link>
        }
      />
